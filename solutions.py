...
## Exercise 1 ------- CHECK IMAGE (exercise1.png)
...
## Exercise 3 ------- CHECK IMAGE (exercise3.png)
...
## Exercise 4 ------- CHECK FILE (first_name_500_times.py)
...
## Exercise 5.a ------- CHECK FILE (full_name.py)
...
## Exercise 5.b - CHECK FILE (full_name.py)
...
## Exercise 6 - CHECK FILE (fahrenheit_to_celsius.py)
